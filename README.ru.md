...
4. Кликните динамик на кольце, чтобы выбрать канал, и нажмите **play**.
   Первый свип сам выставляет уровень под целевой SNR; фейдер слева
   показывает уровень воспроизведения, кнопка-линейка перемеряет его по
   требованию.
...
- **Ручная доводка:** тяните точку на графике, клик по пустому месту
  ...
  помечают фит как `edited`; Re-fit предложит их снести.
